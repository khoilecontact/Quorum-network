...
async function main(){
  ...
  createContract(quorum.member2, quorum.member2.privateKey, tessera.member2.publicKey, tessera.member3.publicKey)
  .then( async function(privateTxReceipt){
    ...
    await setValueAtAddress(quorum.member2, privateTxReceipt.contractAddress, newValue, contractAbi, quorum.member2.privateKey, tessera.member2.publicKey, tessera.member3.publicKey);
